...
The following changes have been implemented in the Blender Dev Tools for PyCharm plugin and should be reflected in the [Wiki](https://sakurasedaia.github.io/PycharmBlenderWiki/).
